    ...
    <nav className="sticky top-0 z-50 border-b border-[rgba(255,255,255,0.06)] bg-[#0a0a0a]">
      ...
      <div className="mx-auto hidden h-14 max-w-7xl items-center gap-5 px-4 lg:flex xl:px-6">
              ...
              >
                {toolsLinks.map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
                    className="flex items-center gap-3 px-4 py-2.5 text-[13px] font-medium text-[#9CA3AF] transition-colors duration-200 hover:bg-[rgba(255,107,53,0.1)] hover:text-white"
                  >
                    <svg
        ...
        <div className="ml-auto flex items-center gap-4">
          ...
          <a
            href="#"
            className="flex items-center text-[#9CA3AF] transition-colors duration-200 hover:text-white"
            aria-label="Settings"
          >
            <svg
              className="h-5 w-5"
