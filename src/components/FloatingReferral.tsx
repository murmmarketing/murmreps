  ...
  return (
    <div className="fixed right-4 top-1/2 z-40 hidden -translate-y-1/2 flex-col gap-2 lg:flex">
      ...
      <a
        ...
        className="flex h-11 w-11 items-center justify-center rounded-full bg-accent font-heading text-xs font-bold text-white transition-all duration-200 hover:scale-110 hover:shadow-[0_0_16px_rgba(255,107,53,0.4)]"
      >
        KKB
      </a>
    </div>
