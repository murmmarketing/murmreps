...
const communityLinks = [
  ...
  { label: "Discord", href: "https://discord.gg/murmreps" },
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-5 flex items-center gap-3">
              ...
              <a href="https://discord.gg/murmreps" target="_blank" rel="noopener noreferrer" className="text-text-muted transition-colors hover:text-accent">
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-2 flex gap-2">
                ...
                />
                <button className="shrink-0 rounded-btn bg-accent px-4 py-2 text-sm font-semibold text-white transition-all hover:shadow-[0_0_20px_rgba(254,66,5,0.15)]">
                  Subscribe
                </button>
              </div>
            </div>
