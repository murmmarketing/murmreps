      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="group rounded-card border border-subtle bg-surface p-6 transition-all duration-200 hover:border-accent/20 hover:shadow-[0_0_20px_rgba(255,107,53,0.05)]"
            >
