...
const guides = [
  ...
  },
  {
    ...
    description: "Interactive color matching — which colors go together for any outfit",
    time: "5 min read",
    href: "/guides/color-guide",
    emoji: "🎨",
    live: true,
  },
  {
    title: "Streetwear Styling Guide",
    description: "6 outfit formulas, layering system, shoe pairing, and common mistakes",
    time: "8 min read",
    href: "/guides/streetwear-styling",
    emoji: "👟",
    live: true,
  },
  {
    title: "Rep Sizing Guide",
    description: "Size charts, measuring tips, and how to get the right fit every time",
    time: "4 min read",
    href: "/guides/sizing-guide",
    emoji: "📐",
    live: true,
  },
  {
