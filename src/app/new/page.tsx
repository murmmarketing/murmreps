...
export const metadata: Metadata = {
  title: "New Drops — Latest Products | MurmReps",
  description: "The latest rep finds added to MurmReps this week. New products added daily.",
};
...
export default async function NewDropsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
      ...
      <p className="mt-2 text-text-secondary">{total} new products this week</p>
      ...
      {items.length === 0 && (
        <div className="mt-16 text-center">
          <p className="text-text-secondary">No new products this week. Check back soon!</p>
