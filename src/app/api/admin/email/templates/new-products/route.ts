            ...
            <a href="https://murmreps.com/products/${left.id}" style="text-decoration:none; display:block;">
              <div style="background:#111; border-radius:12px; overflow:hidden;">
                ...
                <div style="padding:14px;">
                  ...
                  <p style="color:#52525b; font-size:12px; margin:0 0 8px;">${left.brand} · ${left.category}</p>
            ...
            <a href="https://murmreps.com/products/${right.id}" style="text-decoration:none; display:block;">
              <div style="background:#111; border-radius:12px; overflow:hidden;">
                ...
                <div style="padding:14px;">
                  ...
                  <p style="color:#52525b; font-size:12px; margin:0 0 8px;">${right.brand} · ${right.category}</p>
...
function buildNewProductsHTML(products: ProductRow[], totalCount: number): string {
  const productGrid = products.length > 0
    ...
    : '<p style="color:#52525b; font-size:14px; text-align:center; padding:24px 0;">No new products in the last 24 hours.</p>';
...
<body style="margin:0; padding:0; background-color:#0a0a0a; font-family:Arial,Helvetica,sans-serif; -webkit-font-smoothing:antialiased;">
  <div style="max-width:600px; margin:0 auto;">
    ...
    <div style="text-align:center; padding:40px 32px; background:linear-gradient(180deg, #111 0%, #0a0a0a 100%); border-radius:16px; margin:0 16px 24px;">
      <p style="color:#f97316; font-size:13px; text-transform:uppercase; letter-spacing:2px; margin:0 0 12px; font-weight:600;">Just landed</p>
      <h1 style="color:#fff; font-size:32px; font-weight:800; margin:0 0 16px; line-height:1.2; letter-spacing:-0.5px;">${totalCount} New Products 🚀</h1>
      <p style="color:#a1a1aa; font-size:15px; line-height:1.6; margin:0; max-width:400px; display:inline-block;">
        Fresh additions in the last 24 hours. Be the first to cop before they sell out.
      </p>
    </div>
    ...
    <div style="padding:32px 24px 16px;">
      <p style="color:#f97316; font-size:12px; text-transform:uppercase; letter-spacing:2px; margin:0 0 4px; font-weight:600;">New arrivals</p>
      <h2 style="color:#fff; font-size:22px; font-weight:700; margin:0; letter-spacing:-0.3px;">Today's best additions</h2>
    </div>
